...
" Other libraries (Appium)
syn match appiumLibrary     "\c\<\(Background App\|Capture Page Screenshot\|Clear Text\|Click Button\|Click Element\|Close All Applications\|Close Application\|Element Name Should Be\|Element Should Be Disabled\|Element Should Be Enabled\|Get Contexts\|Get Current Context\|Get Network Connection Status\|Get Source\|Go Back\|Go To Url\|Hide Keyboard\|Input Password\|Input Text\|Input Value\|Lock\|Log Source\|Long Press\|Long Press Keycode\|Open Application\|Page Should Contain Element\|Page Should Contain Text\|Page Should Not Contain Element\|Page Should Not Contain Text\|Pinch\|Press Keycode\|Pull File\|Pull Folder\|Push File\|Register Keyword To Run On Failure\|Reset Application\|Scroll\|Set Network Connection Status\|Shake\|Swipe\|Switch Application\|Switch To Context\|Tap\|Wait Until Page Contains\|Zoom\)\>"
...
hi def link robotBuiltin        Keyword
