...
Use these in order of preference for AIDX goal discovery:
...
[UI brief completeness matrix](../design/interaction-design-patterns.md#ui-brief-completeness-before-design-comparison)
