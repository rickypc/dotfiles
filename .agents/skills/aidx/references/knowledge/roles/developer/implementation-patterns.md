...
## Purpose
Standards and patterns for producing clean, maintainable code. These principles apply regardless of language and keep implementation production-worthy, not prototype-quality.
