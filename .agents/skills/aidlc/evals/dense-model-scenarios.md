...
| Stage asset selection | A stage packet is returned | Read only its stage prompt, role prompts, sensors, and typed stage-curated knowledge paths. | Emit or preload all shared knowledge and every file for an assigned role. |
