...
alias server.restart='brew services restart mysql && brew services restart php && sudo brew services restart nginx'
alias server.stop='brew services stop mysql && brew services stop php && sudo brew services stop nginx'
